...
#LoadModule authnz_fcgi_module libexec/apache2/mod_authnz_fcgi.so
...
#
# "/data/data/com.termux/files/usr/lib/cgi-bin" should be changed to whatever your ScriptAliased
...
# Set handler to load php module
<FilesMatch \.php$>
